            ...
            <Card className="p-0 mx-0 rounded-none shadow-none mt-[63px] w-full">
                <CardContent className="m-0 flex justify-end items-center p-3">
                    <div className="flex justify-between items-center">
                        <Link className="button" to="/shiftRequest">
                            <Button className="bg-transparent hover:bg-transparent text-black border border-gray-400">Back</Button>
                        </Link>
                        <Button className="bg-primary-blue hover:bg-primary-blue" onClick={handleSaveClick}>
                            Save
                        </Button>
                    </div>
                </CardContent>
                                         ...
                                         control={form.control}
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <div className="w-full">
                                                        <Input {...field} placeholder="Billing From" readOnly={true} value="Draft" className="mb-5" />
                                                    </div>
                                                </FormItem>
                                            )}
                                        />
